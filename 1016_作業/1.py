...
class GetdataInfo(Dialog):
    ...
    def body(self, master):
        ...
        tk.Label(master, text=row[0]).grid(row=2,column=1, sticky=tk.E)
        tk.Label(master, text=self.lowvar).grid(row=3,column=1, sticky=tk.E)
        tk.Label(master, text=self.closevar).grid(row=4,column=1, sticky=tk.E)
        tk.Label(master, text=self.adjclosevar).grid(row=5,column=1, sticky=tk.E)
        tk.Label(master, text=self.volumevar).grid(row=6,column=1, sticky=tk.E)
